...
const Projects = () => {
  const projects: project[] = [
    {
      id: "jahatstudio",
      imgSrc: "/imges/jahatstudio.png",
      caption:
        "jahatstudio یک پروژه فریلنس مربوط به استدیو تبلیغاتی جهت هستش که به سفارش این مجموعه با دیزاین مد نظرشون کد نویسی کردم  در بخش فرانت از تکنولوژی های React- typeScript- TailwindCss4-React Router DOM -React Hook Form - Zod - ReactSlick - vite استفاده کردم و برای بخش بک اند هم از Nodejs-Express .استفاده کردم ولی هنوز خیلی جای کارداره که انجامش به نظر کارفرما بستگی داره",
    },
    {
      id: "assemblyendgame",
      imgSrc: "/imges/Assmebly.png",
      caption:
    ...
    {
      id: "amazonpracticee",
      imgSrc: "public/imges/amazon-checkout.png",
      caption:
    ...
    },
    {
      ...
      imgSrc: "/imges/memegenerator.png",
      caption:
